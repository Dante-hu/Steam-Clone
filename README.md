...
2. the .env file is required to access the database. You will need an ontario tech email to access the download [here](https://drive.google.com/file/d/1c_5VNUHhn6PHAzzqLHNZNrgSkx0LGbaN/view?usp=sharing), or you can also use the one included in the zip folder submission. Put the file in the base/root directory of the project
3. Install NextJs and Nodejs
   (You need Next and Node js downloaded on your device.)
   [Node Js installing instruction:](https://nodejs.org/en/download)
   [Next js installation instruction:](https://nextjs.org/docs/app/getting-started/installation)

4. Open your terminal at the project directory and install the required packages by running:
